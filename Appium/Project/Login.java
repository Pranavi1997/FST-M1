...
public class Login {
	...
	public void invalidTest() {
	  ...
	  driver.findElement(AppiumBy.xpath(
			  "//android.widget.Button[@text=\"Submit\"]")).click();
	  wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath(
			  "//android.widget.TextView[@text=\"Invalid credentials\"]")));
	  String messageText = driver.findElement(AppiumBy.xpath(
				"//android.widget.TextView[@text=\"Invalid credentials\"]")).getText();		
		System.out.println(messageText);
		assertEquals(messageText,"Invalid credentials");
	}
	@AfterClass
